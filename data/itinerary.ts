  ...
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        group: 'YY+Rae',
        details: {
          recommendations: ['勝林寺後可在東福寺・祇園一帶自由活動，18:00 前回到四条烏丸附近'],
          foodRecs: [
    ...
    activities: [
      {
        ...
        details: {
          recommendations: [
            '11:00 前退房，退房後步行約 5 分至阪急 烏丸站コインロッカー寄放行李（四条通側、大件 ¥700/天）',
          ],
        },
      },
      {
        ...
        type: 'transport',
        details: {
          transportInfo: '阪急 烏丸站 → 河原町站（1 站，3 分）→ 步行穿越祇園・花見小路（約 10 分）→ 京阪 祇園四条站 → 出町柳站（3 站，約 8 分）→ 步行約 10 分至下鴨神社（共約 35 分）',
        },
      },
      {
        id: 'd4-shimogamo',
        ...
        details: {
          ...
          recommendations: [
            ...
            '遊行隊伍 11:30 抵達下鴨神社社頭，可繼續跟隨或在路旁等待',
            '免費觀賞，無需預約',
          ],
        },
      },
      {
        id: 'd4-to-arashiyama',
        time: '12:00',
        title: '移動至嵐山（取行李・寄京都駅）',
        type: 'transport',
        details: {
          transportInfo: '步行約 15 分至今出川站 → 地鐵烏丸線 → 四条站（B 出口）取行李（阪急 烏丸コインロッカー）→ 烏丸線 → 京都站（寄行李）→ JR 山陰本線 → 嵯峨嵐山站（共約 70 分）',
        },
      },
      {
        id: 'd4-arashiyama',
      ...
      },
      {
        ...
        type: 'transport',
        details: {
          transportInfo: 'JR 嵯峨嵐山站 → 京都站（約 17 分）→ 取行李 → JR 新快速 → JR 大阪站（約 30 分）→ 地鐵御堂筋線 梅田 → 難波站（約 10 分）→ 步行至飯店',
        },
      },
      {
        id: 'd4-hotel-osaka',
